...
def welcome(message):
    ...
    with open(f"usernames/{message.from_user.username}.txt", 'w') as file:
...
def q2(message):
    ...
    with open(f"usernames/{message.from_user.username}.txt", 'a') as file:
...
def q10(message):
    ...
    with open(f"usernames/{message.from_user.username}.txt", 'a') as file:
        file.write(f"{message.text}\n\n\n")
        with open(f"usernames/{message.from_user.username}.txt", 'r') as file:
            content = file.read()
